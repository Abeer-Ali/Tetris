...
public class EventController extends KeyAdapter implements ActionListener {
	...
	private static final double PIECE_MOVE_TIME = 0.8; // wait 0.8 s every time piece moves down increase to slow it down
	...
	public EventController(MenuBar menu) {
		this.menu = menu;
		gameOver = false;
		}
/**	Responds to special keys being pressed.Currently just responds to the space key and the q(uit) key */
